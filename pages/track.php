...
<section class="row justify-content-center vh-100">
    <div class="card justify-content-center text-center bg-info text-light" style="width: 45rem; box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px; margin-top: 110px; width: 350px; border-radius: 5px; height: 10rem;">
        <div class="card-body">
			...
			<?php endif ?>
            <span style="font-size: 16px;"><a style="text-decoration:none; width: 7rem; height:1.8rem;" class="btn btn-danger btn-sm text-light" href="<?=root_url("home")?>">Home</a></span>
            </h3>
            </h3>
        </div>
    </div>
...
<section class="row justify-content-center vh-100">
    <div class="card justify-content-center text-center bg-info text-light" style="width: 45rem; box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px; margin-top: 110px; width: 350px; border-radius: 5px; height: 10rem;">
        <div class="card-body">
            <h3>Request not Found!<br><span style="font-size: 16px; font-style:italic; ">return home and submit your request</span><br>
                <span style="font-size: 16px;"><a style="text-decoration:none;" class="btn btn-danger btn-sm text-light" href="<?=root_url("home")?>">Home</a></span>
            </h3>
        </div>
    </div>
</section>
