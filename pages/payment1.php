<?php
    ...
    if (isset($_POST['pay'])) {
        $site_url = 'http://localhost/BTMS2.0/payment1'; // the url of your website
...
<head>
    ...
    <body style="font-family:sans-serif;background-color:#cae5ff;display:flex;align-items:center;justify-content:center;height:95vh;flex-direction:column;">
        ...
        <?php else:?>
            ...
            <h5>Clicking "Back to home" or cancelling payment could rollback your request</h5><br><?php $nmbrs = sanitize_input($_GET['trackingnumber']); ?>
